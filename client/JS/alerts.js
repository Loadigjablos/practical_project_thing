...
function customAlert(typeOfAlertMessage, alertMessage) {
    ...
    shading.className = "absolute top-0 bg-black opacity-25 min-h-[120%] w-[100%]";
    closeAlert.className = "w-[30%] mt-5 mx-auto text-[40px] cursor-pointer hover:bg-[rgba(87,87,87,0.4)]";
    const alertStyle = "absolute top-[40%] left-[32%] text-black w-[35%] text-[1rem] flex flex-col text-center border-2 border-gray-500";
    //Chose alert design 
